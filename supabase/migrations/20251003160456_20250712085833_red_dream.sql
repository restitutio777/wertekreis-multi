/*
  ...
  1. New Tables
    - `events`
      ...
      - `title` (jsonb, required) - Multilingual support
      - `description` (jsonb, required) - Multilingual support
      - `event_date` (date, required)
      - `event_time` (text, required)
      - `location` (jsonb, required) - Multilingual support
...
-- Create events table with JSONB for multilingual fields
